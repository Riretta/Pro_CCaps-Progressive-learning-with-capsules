...
from U_CapsNets.TUCaN_D import *
...
class DynamicUnet(SequentialEx):
    ...
    def __init__(self, encoder, n_out, img_size, num_capsules,num_routes,logits_num,blur=False, blur_final=True, self_attention=False,
        ...
        ni = sizes[-1][1]
        middle_conv =  nn.Sequential(PrimaryCaps(num_capsules=num_capsules,num_routes=num_routes),
                                     DigitCaps(logits_num=logits_num, num_routes=num_routes, num_capsules=num_capsules),
                                     TPrimaryCaps(num_routes,num_capsules,logits_num)).eval()
